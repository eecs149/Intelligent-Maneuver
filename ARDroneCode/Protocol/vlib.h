...
extern "C" C_RESULT video_controller_set_format( video_controller_t* controller, int32_t width, int32_t height );
...
extern "C" C_RESULT  video_controller_set_motion_estimation( video_controller_t* controller, bool_t use_me );
...
/******** API ********/
extern "C" C_RESULT video_codec_open( video_controller_t* controller, codec_type_t codec_type );
extern "C" C_RESULT video_codec_close( video_controller_t* controller );

extern "C" C_RESULT video_decode_picture( video_controller_t* controller, vp_api_picture_t* picture, video_stream_t* ex_stream, bool_t* got_image );
